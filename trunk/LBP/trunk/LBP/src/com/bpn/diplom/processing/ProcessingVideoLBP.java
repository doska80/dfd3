...
public class ProcessingVideoLBP implements IProcessingImage{
...
//								   (int)(videoSize.getHeight() - focusSize.getHeight())/2);
	...
	private LBPImage faceVectorBuilder;
	private int[] storedFaceVector;
	
	final VideoStreamCV wcamCV = new VideoStreamCV(this);
	final ObjectDetection faceDetector = new ObjectDetection();
...
//	int step;
	...
	public ProcessingVideoLBP(Point[] aroundPointsType){
		super();
		faceVectorBuilder = new LBPImage(aroundPointsType, countBlock);
	...
	public static void main(String [] args){
		...
		new Thread(new Runnable(){
			@Override
			public void run() {
				ProcessingVideoLBP instanse = new ProcessingVideoLBP(LBPImage.AROUND_16_POINTS);
				instanse.init();
