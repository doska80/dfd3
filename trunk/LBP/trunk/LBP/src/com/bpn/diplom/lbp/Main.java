...
public class Main {
    ...
    public static final String COMAND_OS_SELECT = "-os";
...
//        List<String> listId = new ArrayList<String>();
        ...
        while( i < args.length){
        	...
        	if(args[i].equals(COMAND_OS_SELECT)){
                i++;
                if(args[i].equalsIgnoreCase("linux"))
                	selectOS = 1;
                else if(args[i].equalsIgnoreCase("windows"))
                	selectOS = 0;
                i++;
                continue;
            }else
